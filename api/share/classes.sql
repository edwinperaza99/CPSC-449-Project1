...
INSERT INTO Section (sectionNumber, CourseCode, InstructorID, CurrentEnrollment, MaxEnrollment, Waitlist, SectionStatus) VALUES
    (1, 'CPSC-101', 2, 0, 30, 0, 'open'),
    (2, 'CPSC-101', 2, 0, 30, 0, 'open'),
    (1, 'CPSC-111', 2, 0, 35, 0, 'open'),
    (2, 'CPSC-111', 7, 0, 25, 0, 'open'),
    (5, 'MATH-201', 3, 0, 25, 0, 'open'),
    (2, 'MATH-201', 8, 0, 30, 0, 'open'),
    (2, 'MATH-201', 9, 0, 20, 0, 'open'),
    (1, 'PHYS-301', 3, 0, 20, 0, 'open'),
    (2, 'PHYS-301', 10, 0, 35, 0, 'open'),
    (1, 'PYS-101', 2, 0, 35, 0, 'open'),
    (2, 'PYS-101', 6, 0, 25, 0, 'open'),
    (1, 'ENG-541', 7, 0, 25, 0, 'open'),
    (2, 'ENG-541', 8, 0, 30, 0, 'open'),
    (1, 'ART-271', 9, 0, 20, 0, 'open'),
    (2, 'ART-271', 10, 0, 35, 0, 'open'),
    (1, 'CHEM-101', 4, 0, 30, 0, 'open'),
    (2, 'CHEM-101', 5, 0, 25, 0, 'open'),
    (1, 'HIST-281', 6, 0, 35, 0, 'open'),
    (2, 'HIST-281', 7, 0, 20, 0, 'open'),
    (1, 'ECON-554', 8, 0, 30, 0, 'open'),
    (2, 'ECON-554', 9, 0, 25, 0, 'open'),
    (1, 'BIOL-211', 10, 0, 20, 0, 'open'),
    (2, 'BIOL-211', 4, 0, 35, 0, 'open'),
    (1, 'CHEM-301', 5, 0, 30, 0, 'open'),
    (2, 'CHEM-301', 6, 0, 25, 0, 'open'),
    (1, 'MATH-202', 7, 0, 35, 0, 'open'),
    (2, 'MATH-202', 8, 0, 20, 0, 'open'),
    (1, 'PHYS-201', 9, 0, 30, 0, 'open'),
    (2, 'PHYS-201', 10, 0, 25, 0, 'open'),
    (1, 'SOC-101', 4, 0, 25, 0, 'open'),
    (2, 'SOC-101', 5, 0, 30, 0, 'open'),
    ...
    (1, 'MATH-301', 10, 0, 20, 0, 'open'),
    (2, 'MATH-301', 4, 0, 35, 0, 'open'),
    (1, 'PHYS-401', 5, 0, 30, 0, 'open'),
    (2, 'PHYS-401', 6, 0, 25, 0, 'open'),
    (1, 'BUS-201', 7, 0, 35, 0, 'open'),
    (2, 'BUS-201', 8, 0, 20, 0, 'open'),
    (1, 'ENG-431', 9, 0, 30, 0, 'open'),
    (2, 'ENG-431', 10, 0, 25, 0, 'open'),
    (1, 'PHIL-202', 4, 0, 25, 0, 'open'),
    (2, 'PHIL-202', 5, 0, 30, 0, 'open'),
    (1, 'ART-413', 6, 0, 20, 0, 'open');
